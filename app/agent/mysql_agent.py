...
class SQLQueryHandler:
    def __init__(self):
        ...
        self.sql_writer = ConversableAgent(
            ...
            system_message="You are good at writing SQL queries and sugguest graphs.suggest what graph to use from PIE, BAR , LINE , TABLE  or CARD based on the phase. default CARD. Always respond with a function call to execute_sql().",
